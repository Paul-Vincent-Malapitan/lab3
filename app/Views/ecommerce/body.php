...
<div class="product-section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                <a class="product-item" href="cart.html">
                    <img src="<?= base_url(); ?>ecommerce/images/product-2.png" class="img-fluid product-thumbnail">
            ...
            <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                <a class="product-item" href="cart.html">
                    <img src="<?= base_url(); ?>ecommerce/images/product-3.png" class="img-fluid product-thumbnail">
                                    ...
                                    <div class="testimonial-block text-center">
                                        ...
                                        <div class="author-info">
                                            <div class="author-pic">
                                                <img src="<?= base_url(); ?>ecommerce/images/person-1.png" alt="Maria Jones" class="img-fluid">
                                            </div>
